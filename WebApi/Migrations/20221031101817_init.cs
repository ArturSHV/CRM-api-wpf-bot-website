    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "mail1@mail.ru", "Петров Петр" },
                    { 2, "mail2@mail.ru", "Михайлов Михаил" },
                    { 3, "mail3@mail.ru", "Иванов Иван" },
                    { 4, "mail4@mail.ru", "Афанасьев Афанасий" }
                });
        }
